    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500">Métricas en tiempo real del sistema</p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-400 mt-1">Ingresos mensuales recurrentes</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-400 mt-1">de {stats?.totalUsers || 0} totales</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900 mt-1">{stats?.newThisMonth || 0}</p>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-500">Por vencer (7 días)</p>
              <p className="text-3xl font-bold text-gray-900 mt-1">{stats?.expiringThisWeek || 0}</p>
              <p className="text-xs text-gray-400 mt-1">Requieren atención</p>
            </div>
            <div className={`p-3 rounded-xl ${stats?.expiringThisWeek > 0 ? 'bg-orange-100' : 'bg-gray-100'}`}>
              <AlertTriangle className={`w-8 h-8 ${stats?.expiringThisWeek > 0 ? 'text-orange-600' : 'text-gray-400'}`} />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <div className="flex items-end gap-2">
            <span className="text-4xl font-bold text-indigo-600">{stats?.conversionRate || 0}%</span>
            <span className="text-sm text-gray-400 mb-1">trial a pago</span>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <div className="flex items-end gap-2">
            <span className="text-4xl font-bold text-green-600">S/ {stats?.totalRevenue?.toFixed(2) || '0.00'}</span>
          </div>
