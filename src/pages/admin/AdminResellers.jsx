  ...
  return (
    ...
    >
      ...
      {showDepositModal && selectedReseller && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          {/* Con desplazamiento, como el de editar: en un celular chico con el
              teclado abierto el botón de confirmar quedaba fuera de la
              pantalla y no había cómo llegar a él. */}
          <div className="bg-white rounded-lg shadow-lg border border-gray-200 w-full max-w-md max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-gray-200 flex items-center justify-between">
