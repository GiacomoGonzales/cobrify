 ...
 *   6. Zona de peligro: el borrado masivo, con la regla del commit 859a9dd0
 *      intacta: solo dueño o administrador, ELIMINAR más la contraseña, y
 *      comprobantes/guías únicamente el administrador de Cobrify.
 *   7. Versión: dato técnico para soporte, al final porque casi nunca se mira.
 *
 ...
 *
 * El detector de pagos Yape VIVIA aquí y se fue a Integraciones el 2026-09-07:
 * es una integración con una app de fuera, igual que Rappi, y era la sección
 * más larga de una página que va de identidad y permisos. Está en
 * `components/settings/DetectorYape.jsx`.
 *
