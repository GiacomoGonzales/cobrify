  ...
  sections: [
...

    {
      ...
      blocks: [
        {
          type: 'texto',
          text: 'Para rubros que necesitan un dato más por venta, hay campos opcionales que se capturan en el POS y viajan al comprobante. El campo **Alumno** (colegios, academias) agrega su columna a esta tabla y — importante — deja **buscar el comprobante por el nombre del alumno**, que suele ser lo único que el padre recuerda. El campo **Placa de Vehículo** (talleres, lavaderos) se muestra en el detalle y en el documento.',
        },
        {
          type: 'enlace',
