...
export const GUIDES = [
  {
    ...
    category: 'Operación',
    description: 'Crear y confirmar reservas, check-in y check-out, registro de huéspedes con enlace y reprogramar con fecha abierta.',
    keywords: 'reserva reservas hotel hospedaje cabaña cabana habitacion huesped check-in check-out folio registro de huespedes enlace formulario ficha whatsapp excel documento nacionalidad fecha de nacimiento reprogramar reprogramacion fecha abierta limite seis meses postergar cambiar fechas',
    modos: ['hotel'],
  ...
  },
  {
    ...
    keywords: 'clinica estetica dental consultorio odontologo podologia paciente pacientes tratamiento tratamientos profesional profesionales agenda cita citas reserva online recordatorio empezar modo cambiar de modo ficha alergias antecedentes galeria fotos antes despues registrar atencion paquete paquetes sesiones anamnesis enfermedades medicacion habitos embarazo preguntas propias consentimiento informado firma firmar pdf plantilla',
    modos: ['clinic'],
