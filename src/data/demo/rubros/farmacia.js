...
export default {
  ...
  productos: [
    ...
    { id: 'fa1', code: 'MED-PAR-500', imageUrl: 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=400&h=400&fit=crop', sku: 'MED-PAR-500', barcode: '7755001000018', name: 'Paracetamol 500mg x 100 tabletas', description: 'Analgésico y antipirético', price: 8.50, cost: 4.00, stock: 200, unit: 'CAJA', category: 'cat-analgesicos', laboratoryId: 'lab1', laboratoryName: 'MEDIFARMA', marca: 'PANADOL', requiresPrescription: false, ventaTipica: 3, minStock: 40 },
    { id: 'fa2', code: 'MED-IBU-400', imageUrl: 'https://images.unsplash.com/photo-1587854692152-cbe660dbde88?w=400&h=400&fit=crop', sku: 'MED-IBU-400', barcode: '7755001000025', name: 'Ibuprofeno 400mg x 50 tabletas', price: 12.00, cost: 6.00, stock: 140, unit: 'CAJA', category: 'cat-analgesicos', laboratoryId: 'lab2', laboratoryName: 'FARMINDUSTRIA', marca: 'DOLOFLAM', requiresPrescription: false, ventaTipica: 3, minStock: 30 },
    { id: 'fa3', code: 'MED-NAP-550', imageUrl: 'https://images.unsplash.com/photo-1587854692152-cbe660dbde88?w=400&h=400&fit=crop', sku: 'MED-NAP-550', barcode: '7755001000032', name: 'Naproxeno sódico 550mg x 20 tab', price: 18.00, cost: 9.50, stock: 90, unit: 'CAJA', category: 'cat-analgesicos', laboratoryId: 'lab3', laboratoryName: 'GENFAR', marca: 'FLANAX', requiresPrescription: false, ventaTipica: 2, minStock: 20 },
    ...
    { id: 'fa5', code: 'MED-AMO-500', imageUrl: 'https://images.unsplash.com/photo-1471864190281-a93a3070b6de?w=400&h=400&fit=crop', sku: 'MED-AMO-500', barcode: '7755001000056', name: 'Amoxicilina 500mg x 21 cápsulas', price: 22.00, cost: 12.00, stock: 60, unit: 'CAJA', category: 'cat-antibioticos', laboratoryId: 'lab1', laboratoryName: 'MEDIFARMA', marca: 'AMOXIL', requiresPrescription: true, ventaTipica: 1, minStock: 15 },
    { id: 'fa6', code: 'MED-AZI-500', imageUrl: 'https://images.unsplash.com/photo-1585435557343-3b092031a831?w=400&h=400&fit=crop', sku: 'MED-AZI-500', barcode: '7755001000063', name: 'Azitromicina 500mg x 3 tabletas', price: 28.00, cost: 16.50, stock: 45, unit: 'CAJA', category: 'cat-antibioticos', laboratoryId: 'lab5', laboratoryName: 'PFIZER', marca: 'ZITHROMAX', requiresPrescription: true, ventaTipica: 1, minStock: 12 },
    { id: 'fa7', code: 'MED-CIP-500', imageUrl: 'https://images.unsplash.com/photo-1559757175-5700dde675bc?w=400&h=400&fit=crop', sku: 'MED-CIP-500', name: 'Ciprofloxacino 500mg x 10 tab', price: 19.50, cost: 10.20, stock: 52, unit: 'CAJA', category: 'cat-antibioticos', laboratoryId: 'lab3', laboratoryName: 'GENFAR', marca: 'CIPROXINA', requiresPrescription: true, ventaTipica: 1, minStock: 12 },

    // — Gastrointestinales —
    { id: 'fa8', code: 'MED-OME-20', imageUrl: 'https://images.unsplash.com/photo-1626716493137-b67fe9501e76?w=400&h=400&fit=crop', sku: 'MED-OME-20', barcode: '7755001000087', name: 'Omeprazol 20mg x 30 cápsulas', price: 16.00, cost: 8.20, stock: 110, unit: 'CAJA', category: 'cat-gastro', laboratoryId: 'lab2', laboratoryName: 'FARMINDUSTRIA', marca: 'OMEPRAZOL', requiresPrescription: false, ventaTipica: 2, minStock: 25 },
    { id: 'fa9', code: 'MED-SAL-SOB', imageUrl: 'https://images.unsplash.com/photo-1583947215259-38e31be8751f?w=400&h=400&fit=crop', sku: 'MED-SAL-SOB', barcode: '7755001000094', name: 'Sales de rehidratación oral x 10 sobres', price: 11.00, cost: 5.40, stock: 130, unit: 'CAJA', category: 'cat-gastro', laboratoryId: 'lab1', laboratoryName: 'MEDIFARMA', marca: 'ELECTROLIT', requiresPrescription: false, ventaTipica: 3, minStock: 30 },
    ...
    // — Vías respiratorias —
    { id: 'fa11', code: 'MED-LOR-10', imageUrl: 'https://images.unsplash.com/photo-1576602976047-174e57a47881?w=400&h=400&fit=crop', sku: 'MED-LOR-10', barcode: '7755001000117', name: 'Loratadina 10mg x 20 tabletas', price: 13.00, cost: 6.30, stock: 95, unit: 'CAJA', category: 'cat-respiratorio', laboratoryId: 'lab3', laboratoryName: 'GENFAR', marca: 'CLARITYNE', requiresPrescription: false, ventaTipica: 2, minStock: 22 },
    { id: 'fa12', code: 'MED-JAR-TOS', imageUrl: 'https://images.unsplash.com/photo-1584017911766-d451b3d0e843?w=400&h=400&fit=crop', sku: 'MED-JAR-TOS', barcode: '7755001000124', name: 'Jarabe para la tos 120ml', price: 21.00, cost: 11.00, stock: 70, unit: 'FRASCO', category: 'cat-respiratorio', laboratoryId: 'lab2', laboratoryName: 'FARMINDUSTRIA', marca: 'NOTUSIN', requiresPrescription: false, ventaTipica: 2, minStock: 18 },
