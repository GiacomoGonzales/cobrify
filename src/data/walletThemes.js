...
export const SELLOS_TARJETA = [
  { id: 'check', nombre: 'Check', grosor: 6.5, trazo: '<path d="M19 33 l9 9 L45 23"/>' },
  { id: 'estrella', nombre: 'Estrella', grosor: 4.5, trazo: '<path d="M32 13 l6.2 12.6 13.8 2 -10 9.8 2.4 13.8 -12.4 -6.5 -12.4 6.5 2.4 -13.8 -10 -9.8 13.8 -2 Z"/>' },
  { id: 'corazon', nombre: 'Corazón', grosor: 4.5, trazo: '<path d="M32 49 C10 34 15 13 32 23 C49 13 54 34 32 49 Z"/>' },
  { id: 'taza', nombre: 'Taza', grosor: 4.5, trazo: '<path d="M16 26 h24 v10 a12 12 0 0 1 -24 0 z"/><path d="M40 28 h5 a6 6 0 0 1 0 12 h-4"/><path d="M23 12 q3 4 0 9 M31 12 q3 4 0 9"/>' },
  { id: 'pizza', nombre: 'Pizza', grosor: 4.5, trazo: '<path d="M14 18 L50 18 L32 52 Z"/><circle cx="27" cy="26" r="3"/><circle cx="38" cy="25" r="3"/><circle cx="32" cy="35" r="3"/>' },
  { id: 'hamburguesa', nombre: 'Hamburguesa', grosor: 4.5, trazo: '<path d="M15 27 a17 13 0 0 1 34 0 v1 H15 Z"/><path d="M14 34 h36"/><path d="M16 40 h32 v3 a5 5 0 0 1 -5 5 H21 a5 5 0 0 1 -5 -5 Z"/>' },
  { id: 'huella', nombre: 'Huella', grosor: 4.5, trazo: '<ellipse cx="32" cy="41" rx="10" ry="8"/><circle cx="18" cy="29" r="4.5"/><circle cx="27" cy="21" r="4.5"/><circle cx="37" cy="21" r="4.5"/><circle cx="46" cy="29" r="4.5"/>' },
  { id: 'tijeras', nombre: 'Tijeras', grosor: 4.5, trazo: '<circle cx="20" cy="42" r="6"/><circle cx="20" cy="22" r="6"/><path d="M25 25 L48 44 M25 39 L48 20"/>' },
  { id: 'cruz', nombre: 'Cruz', grosor: 4.5, trazo: '<path d="M26 14 h12 v12 h12 v12 H38 v12 H26 V38 H14 V26 h12 Z"/>' },
  { id: 'polo', nombre: 'Polo', grosor: 4, trazo: '<path d="M24 13 l-11 8 5 8 5 -3 v26 h18 V26 l5 3 5 -8 -11 -8 a8 5 0 0 1 -16 0 z"/>' },
]
  ...
  for (let f = 0; f < filas; f++) {
    ...
    for (let c = 0; c < enFila; c++) {
      ...
      if (i < s) {
        ...
        celdas += `<g transform="translate(${x + off} ${y + off}) scale(${esc.toFixed(3)})" fill="none" stroke="${colorFondo}" stroke-width="${sello.grosor}" stroke-linecap="round" stroke-linejoin="round">${sello.trazo}</g>`
      } else {
