      ...
      training: [
        {
          id: 'cert-train-1',
          type: 'training',
          certificateNumber: 'CAP-2025-001',
          customerId: '2',
          customerName: 'CLINICA SAN PABLO SAC',
          customerRuc: '20456789012',
          customerAddress: 'Av. El Polo 789, Surco',
          date: new Date(today.getFullYear(), today.getMonth(), 5).toISOString(),
          duration: '120 minutos',
          instructor: 'Ing. Roberto Sánchez Pérez',
          trainingTitle: 'USO Y MANEJO CORRECTO DEL EXTINTOR',
          topics: ['Clases de fuego', 'Tipos de extintores', 'Técnicas de extinción', 'Evacuación', 'Primeros auxilios'],
          participants: [
            { name: 'Ana María Torres', dni: '45678912' },
            { name: 'Carlos Eduardo Ríos', dni: '32165498' },
            { name: 'Patricia Mendoza Luna', dni: '78945612' },
            { name: 'José Luis García', dni: '65412378' }
          ],
          status: 'active',
        ...
        },
        {
          id: 'cert-train-2',
          type: 'training',
          certificateNumber: 'CAP-2025-002',
          customerId: '4',
          customerName: 'BOTICA POPULAR EIRL',
          customerRuc: '20567890123',
          customerAddress: 'Av. Abancay 890, Lima',
          ...
          participants: [
            { name: 'Miguel Vargas Peña', dni: '78901234' },
            { name: 'Elena Castro Vera', dni: '79012345' }
          ],
          status: 'active',
      ...
      operability: [
        {
          id: 'cert-oper-1',
          type: 'operability',
          certificateNumber: 'OPE-2025-001',
          customerId: '2',
          customerName: 'CLINICA SAN PABLO SAC',
          customerRuc: '20456789012',
          customerAddress: 'Av. El Polo 789, Surco',
          serviceDate: new Date(today.getFullYear(), today.getMonth(), 3).toISOString(),
          expirationDate: new Date(today.getFullYear() + 1, today.getMonth(), 3).toISOString(),
          technician: 'Téc. Luis Fernández',
          guaranteePeriod: '12 meses',
          extinguishers: [
            { type: 'PQS', capacity: '6 kg', serial: 'EXT-CSP-001', brand: 'Badger', location: 'Recepción', serviceType: 'recarga' },
            { type: 'PQS', capacity: '6 kg', serial: 'EXT-CSP-002', brand: 'Badger', location: 'Farmacia', serviceType: 'recarga' },
            { type: 'CO2', capacity: '5 kg', serial: 'EXT-CSP-003', brand: 'Amerex', location: 'Laboratorio', serviceType: 'mantenimiento' },
            { type: 'PQS', capacity: '4 kg', serial: 'EXT-CSP-004', brand: 'Kidde', location: 'Almacén', serviceType: 'recarga' }
          ],
          status: 'active',
        ...
        },
        {
          id: 'cert-oper-2',
          type: 'operability',
          certificateNumber: 'OPE-2025-002',
          customerId: '4',
          customerName: 'BOTICA POPULAR EIRL',
          customerRuc: '20567890123',
          customerAddress: 'Av. Abancay 890, Lima',
          serviceDate: new Date(today.getFullYear(), today.getMonth() - 1, 10).toISOString(),
          expirationDate: new Date(today.getFullYear() + 1, today.getMonth() - 1, 10).toISOString(),
          technician: 'Téc. Luis Fernández',
          guaranteePeriod: '12 meses',
          extinguishers: [
            { type: 'PQS', capacity: '6 kg', serial: 'EXT-BP-001', brand: 'Badger', location: 'Mostrador', serviceType: 'recarga' },
            { type: 'PQS', capacity: '4 kg', serial: 'EXT-BP-002', brand: 'Kidde', location: 'Almacén', serviceType: 'mantenimiento' }
          ],
          status: 'active',
    ...
    purchaseOrders: [
      {
        ...
        items: [
          { id: 'oci1', productId: '1', code: 'MED001', description: 'Paracetamol 500mg Tabletas', quantity: 100, unitPrice: 4.00, unit: 'CAJA' },
          { id: 'oci2', productId: '2', code: 'MED002', description: 'Ibuprofeno 400mg Tabletas', quantity: 80, unitPrice: 6.00, unit: 'CAJA' },
          { id: 'oci3', productId: '7', code: 'JAR001', description: 'Ambroxol Jarabe 120ml', quantity: 50, unitPrice: 5.50, unit: 'FRASCO' },
        ],
        subtotal: 1155.00,
        igv: 207.90,
        total: 1362.90,
        status: 'pending',
        expectedDeliveryDate: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 5),
        notes: 'Reposición mensual de analgésicos y jarabes',
      ...
      },
      {
        ...
        items: [
          { id: 'oci4', productId: '10', code: 'MED010', description: 'Omeprazol 20mg Cápsulas', quantity: 60, unitPrice: 7.00, unit: 'CAJA' },
          { id: 'oci5', productId: '18', code: 'VIT002', description: 'Complejo B Tabletas', quantity: 40, unitPrice: 11.00, unit: 'FRASCO' },
          { id: 'oci6', productId: '20', code: 'VIT004', description: 'Hierro + Ácido Fólico Tabletas', quantity: 30, unitPrice: 5.50, unit: 'CAJA' },
        ],
        subtotal: 1025.00,
        igv: 184.50,
        total: 1209.50,
        status: 'sent',
        isSent: true,
        sentAt: new Date(today.getFullYear(), today.getMonth(), today.getDate() - 2),
        sentVia: ['email'],
        expectedDeliveryDate: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 3),
        notes: 'Pedido urgente - bajo stock de vitaminas',
      ...
      },
      {
        ...
        items: [
          { id: 'oci7', productId: '4', code: 'MED004', description: 'Amoxicilina 500mg Cápsulas', quantity: 40, unitPrice: 9.00, unit: 'CAJA' },
          { id: 'oci8', productId: '5', code: 'MED005', description: 'Azitromicina 500mg Tabletas', quantity: 30, unitPrice: 12.00, unit: 'CAJA' },
          { id: 'oci9', productId: '6', code: 'MED006', description: 'Ciprofloxacino 500mg Tabletas', quantity: 25, unitPrice: 14.00, unit: 'CAJA' },
        ],
        subtotal: 1070.00,
        igv: 192.60,
        total: 1262.60,
        status: 'received',
        relatedPurchaseId: '1',
        receivedAt: new Date(today.getFullYear(), today.getMonth(), today.getDate() - 5),
        expectedDeliveryDate: new Date(today.getFullYear(), today.getMonth(), today.getDate() - 7),
        notes: 'Antibióticos - Recibido completo',
      ...
      },
      {
        ...
        items: [
          { id: 'oci10', productId: '24', code: 'HIG001', description: 'Alcohol en Gel 500ml', quantity: 100, unitPrice: 7.00, unit: 'FRASCO' },
          { id: 'oci11', productId: '25', code: 'HIG002', description: 'Alcohol Medicinal 70° 1L', quantity: 50, unitPrice: 5.50, unit: 'FRASCO' },
        ],
        subtotal: 975.00,
        igv: 175.50,
        total: 1150.50,
        status: 'cancelled',
        cancellationReason: 'Proveedor no tiene stock disponible',
        cancelledAt: new Date(today.getFullYear(), today.getMonth(), today.getDate() - 8),
        expectedDeliveryDate: new Date(today.getFullYear(), today.getMonth(), today.getDate() - 12),
        notes: 'Pedido de productos de higiene - CANCELADO',
