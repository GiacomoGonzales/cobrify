...
export const COLUMNAS_COMPROBANTES = [
  ...
  { key: 'NOMBRE_CLIENTE', header: 'NOMBRE / RAZÓN SOCIAL', width: 32, nota: 'Nombre completo o razón social del cliente. Con RUC o DNI puedes dejarlo vacío: al subir el archivo se completa con SUNAT (RUC) o RENIEC (DNI).' },
  { key: 'DIRECCION_CLIENTE', header: 'DIRECCIÓN', width: 28, nota: 'Opcional. Si la dejas vacía, se completa con el domicilio fiscal de SUNAT (RUC) o con la dirección de tu cliente registrado.' },
...
export async function generarPlantillaComprobantes() {
  ...
  const reglas = [
    ...
    '5. Con RUC o DNI basta el número: si dejas vacíos NOMBRE / RAZÓN SOCIAL y DIRECCIÓN, se completan al subir el archivo (SUNAT para RUC, RENIEC para DNI). Lo que escribas no se cambia.',
    '',
