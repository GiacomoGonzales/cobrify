...
export const RETAIL_PAGES = [
  ...
  // Envíos
  { id: 'envios', name: 'Envíos', path: '/envios', category: 'otros' },
  // Otros
...
export const createManagedUser = async (ownerId, userData) => {
  try {
    ...
    const userDocData = {
      ...
      // Repartidor asignado: si está puesto, en Envíos solo ve SUS entregas.
      assignedMotoristaId: userData.assignedMotoristaId || null,
      assignedMotoristaName: userData.assignedMotoristaName || null,
      ...
      // ¿Puede cambiarse la contraseña solo? Lo enciende el dueño en Gestión de
      // usuarios. Apagado por defecto y para los que ya existen: la clave de un
      // cajero la maneja el dueño salvo que decida lo contrario.
      puedeCambiarSuClave: userData.puedeCambiarSuClave === true,
