...
export const CATALOG_THEMES = {
  ...
  mercado: {
    id: 'mercado',
    name: 'Mercado',
    description: 'Fresco y cercano, con categorías en círculos con foto. Bodegas, minimarkets y mercados',
    category: 'general',
    isNew: true,
    swatch: { bg: '#F6FBF7', card: '#FFFFFF', accent: '#059669' },
    accent: '#059669',
    fonts: {
    ...
    // Círculos con foto de categoría (estilo apps de delivery) + grilla uniforme
    layout: { hero: 'classic', categories: 'circles', grid: 'grid', card: 'classic' },
    classes: {
      bg: 'bg-[#F6FBF7]',
      card: 'bg-white',
      cardShadow: 'bg-white shadow-emerald-900/5',
      text: 'text-[#14291D]',
      textMuted: 'text-[#5C7A68]',
      textFaint: 'text-[#7E9C8A]',
      obsText: 'text-[#31513E]',
      headerBg: 'bg-white shadow-emerald-900/5',
      catInactive: 'bg-white text-[#31513E] border border-[#D6EEE0] hover:bg-[#EFF9F3]',
      viewActive: 'bg-[#D6EEE0]',
      viewHover: 'hover:bg-[#EFF9F3]',
      catBadge: 'bg-white/90 text-[#047857]',
      listBadge: 'bg-[#EFF9F3] text-[#047857]',
      searchBanner: 'bg-white text-[#14291D] placeholder-[#7E9C8A] border border-[#D6EEE0] focus:ring-[#059669]/30',
      searchClassic: 'bg-white text-[#14291D] placeholder-[#7E9C8A] border border-[#D6EEE0]',
      borderColor: 'border-[#D6EEE0]',
      footerPowered: 'text-[#7E9C8A] border-[#D6EEE0]',
      footerLink: 'text-[#5C7A68]',
      heroFallbackBg: 'bg-[#F6FBF7]',
      cartBadgeBg: '#059669',
      cartBadgeColor: '#fff',
      cardRadius: 'rounded-2xl',
      cardShadowEffect: 'shadow-sm hover:shadow-lg shadow-emerald-900/10',
      productNameClass: 'text-sm font-semibold',
      priceClass: 'text-base font-bold text-[#047857]',
      detailNameClass: 'text-2xl font-bold text-gray-900',
      detailPriceClass: 'text-3xl font-bold text-[#047857]',
      fontWrapper: 'font-sans',
    },
  },
  ...
  sabor: {
    id: 'sabor',
    name: 'Sabor',
    description: 'Carbón y cobre con portada a pantalla completa y serif cálida. Restaurantes y cocinas de autor',
    category: 'restaurant',
    isNew: true,
    swatch: { bg: '#1C1917', card: '#292524', accent: '#B87333' },
    accent: '#B87333',
    fonts: {
      // Playfair Display ya viene en el bundle (font-serif de Tailwind); se
      // declara heading para que .catalog-heading (hero full-bleed) la use.
      heading: "'Playfair Display', Georgia, serif",
      body: null,
      googleFontsUrl: null,
    },
    // Portada a pantalla completa con contenido centrado + tabs subrayadas
    layout: { hero: 'full-bleed', categories: 'underline', grid: null, card: 'classic' },
    classes: {
      bg: 'bg-[#1C1917]',
      card: 'bg-[#292524]',
      cardShadow: 'bg-[#292524] shadow-black/40',
      text: 'text-[#FAF7F2]',
      textMuted: 'text-[#A8A29E]',
      textFaint: 'text-[#78716C]',
      obsText: 'text-[#D6D3D1]',
      headerBg: 'bg-[#1C1917] border-b border-[#B87333]/30',
      catInactive: 'bg-[#292524] text-[#A8A29E] hover:bg-[#3D3835] hover:text-[#FAF7F2]',
      viewActive: 'bg-[#3D3835]',
      viewHover: 'hover:bg-[#292524]',
      catBadge: 'bg-[#1C1917]/90 text-[#B87333]',
      listBadge: 'bg-[#3D3835] text-[#A8A29E]',
      searchBanner: 'bg-[#292524] text-[#FAF7F2] placeholder-[#78716C] border border-[#B87333]/30 focus:ring-[#B87333]/40',
      searchClassic: 'bg-[#292524] text-[#FAF7F2] placeholder-[#78716C] border border-[#B87333]/30',
      borderColor: 'border-[#3D3835]',
      footerPowered: 'text-[#78716C] border-[#3D3835]',
      footerLink: 'text-[#A8A29E]',
      heroFallbackBg: 'bg-[#292524]',
      cartBadgeBg: '#B87333',
      cartBadgeColor: '#1C1917',
      cardRadius: 'rounded-lg',
      cardShadowEffect: 'shadow-lg hover:shadow-2xl shadow-black/40',
      productNameClass: 'font-serif text-base font-semibold',
      priceClass: 'text-lg font-serif font-bold text-[#B87333]',
      detailNameClass: 'font-serif text-2xl font-semibold text-gray-900',
      detailPriceClass: 'font-serif text-3xl font-bold text-[#8A5626]',
      fontWrapper: 'font-sans',
    },
  },
